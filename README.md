...
* Optionally configure MDEditor to insert the stylesheet into the DOM so you don't have to manage it manually.
...
```html
<!-- MDEditor CSS -->
<link rel="stylesheet" href="https://MegaMind-Solution.github.io/MDEditor/MDEditor.css">

<!-- MDEditor JS -->
<script src='https://MegaMind-Solution.github.io/MDEditor/MDEditor.js'></script>
```
...
### 3. Initialize MDEditor

```javascript
document.addEventListener('DOMContentLoaded', () => {
   const editor = new MDEditor('content', {
      bold: true,
      italic: true,
      underline: true,
      strikethrough: true,
...
```
{
  "url" : "https://demo.com/dumy/file/image.png"
}
```
...
* **GitHub**: [yeole-rohan/ray-editor](https://github.com/MegaMind-Solution/MDEditor )
* **CDN**: [jsDelivr - MDEditor](https://www.jsdelivr.com/package/npm/MDEditor)
